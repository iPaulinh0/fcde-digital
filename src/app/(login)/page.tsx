...
export default function Home() {
  return (
    <div className="flex flex-col items-center min-h-screen justify-center bg-zinc-300 font-sans">
     ...
     <div className="flex flex-col items-center justify-center bg-zinc-200 rounded-lg px-4 py-10">
      ...
      <form className="flex flex-col items-center justify-center">
        ...
        <button type="submit" className="bg-red-700 text-zinc-100 rounded-md p-1 w-full font-medium text-center text-base mt-2 hover:bg-red-800 cursor-pointer transition-all duration-100">Entrar</button>
