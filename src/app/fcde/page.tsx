...
export default function FCDE() {
  return (
    <div className="flex flex-col items-center justify-center bg-zinc-300 font-sans">
      <div className="flex flex-col items-center justify-center bg-zinc-200 rounded-lg px-4 py-6">
